...
int main(int argc, char** argv) {
    const char* files[] = {
        "instrument-profiles/violin-gdae.json",
        "instrument-profiles/viola-cgda.json",
        "instrument-profiles/cello-cgda.json",
        "instrument-profiles/doublebass-eadg.json",
    };
    ...
    // An unknown enum string must be REJECTED, not silently defaulted.
    {
        ...
        std::string base = slurp(root + "/instrument-profiles/violin-gdae.json");
        JsonDocument doc;
